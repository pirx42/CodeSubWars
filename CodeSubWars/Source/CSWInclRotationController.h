...
namespace CodeSubWars
{
  ...
  class CSWInclRotationController : public CSWController
  {
    public:
      typedef std::shared_ptr<CSWInclRotationController> PtrType;
      ...
      virtual ~CSWInclRotationController();
    ...
    protected:
      CSWInclRotationController(std::shared_ptr<CSWControlCenter> pControlCenter,
                                std::shared_ptr<CSWEngine> pEngine, 
                                double fEndDirection, double fDirectionTolerance,
                                double fEndVelocity, double fVelocityTolerance, 
                                int nProperties, 
