...
namespace CodeSubWars
{
  ...
  class CSWMoveUpwardCommand : public ARSTD::Command
  {
    public:
      typedef std::shared_ptr<CSWMoveUpwardCommand> PtrType;
    ...
    protected:
      CSWMoveUpwardCommand(std::shared_ptr<CSWControlCenter> pControlCenter,
                           std::shared_ptr<CSWEngine> pEngine, 
                           double fSetRelativePosition, double fPositionTolerance,
                           double fEndVelocity, double fVelocityTolerance, 
      ...
      CSWMoveUpwardCommand(const CSWMoveUpwardCommand& other);
