...
bool DT_Triangle::ray_cast(const MT_Point3& source, const MT_Point3& target, const MT_Scalar& margin, 
						   MT_Scalar& param, MT_Vector3& normal) const 
{
  if (margin > 0) throw std::runtime_error("DT_Box::ray_cast(): margin is not supported");
