...
bool DT_Convex::ray_cast(const MT_Point3& source, const MT_Point3& target, const MT_Scalar& margin, MT_Scalar& lambda, MT_Vector3& normal) const
{
	// Still working on this one...
throw std::runtime_error("convex::ray_cast(): does not support by this shape type");	
    return false;
}
